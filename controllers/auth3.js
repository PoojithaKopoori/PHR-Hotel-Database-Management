...
var count;
     db.query('SELECT rooms_available from premiumroomsavailable;',function(error,resul){
       if(error){
         console.log(error);
                ...
                if (results.length > 0) {
                  ...
                  db.query('INSERT INTO customer SET ?', {
                      ...
                      if (error) {
                        ...
                        db.query('UPDATE premiumroomsavailable SET rooms_available=rooms_available-1');
                        // res.render('display');
